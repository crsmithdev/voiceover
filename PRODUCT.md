...
4. **Report.** Outcome and reason, answered by, clean or not, duration, what was said and heard, blocked items that need Chris, a warning when a machine question went unanswered, per-turn latency. Reports live in `~/.caller/reports` for 30 days and the UI lists them (18.6).
