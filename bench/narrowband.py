...
"""
import difflib, glob, json, os, re, statistics, subprocess
...
for i, line in enumerate(LINES):
    ...
    sox("-m", uln, "|sox -r 8000 -n -c 1 -e u-law -p synth 6 whitenoise vol 0.012",
        "-r", "16000", "-c", "1", "-e", "signed-integer", "-b", "16", noisy)
...
print(f"\n{len(LINES)} lines, {total} words as the clean audio was heard")
